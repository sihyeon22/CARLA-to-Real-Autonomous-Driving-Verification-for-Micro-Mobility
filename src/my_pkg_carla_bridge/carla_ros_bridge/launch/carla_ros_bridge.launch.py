...
def generate_launch_description():
    ld = launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument(
            name='publish_sensor_tf',
            default_value='True',
            description='Enable/disable TF publication from bridge-managed sensors and tf pseudo sensors'
        ),
        launch.actions.DeclareLaunchArgument(
        ...
        launch_ros.actions.Node(
            ...
            parameters=[
                ...
                {
                    'publish_sensor_tf': launch.substitutions.LaunchConfiguration('publish_sensor_tf')
                },
                {
